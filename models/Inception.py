...
class InceptionV3(nn.Module):
    ...
    def __init__(self, num_classes=100, norm = False, mean = None, std = None):
        ...
        self.linear = nn.Linear(2048, self._num_classes)
    ...
    def num_classes(self, value):
        ...
        self.linear = nn.Linear(2048, self._num_classes).to(self.linear.weight.device)
...
def Inc_V3(Num_class=10, Norm=True, norm_mean=None, norm_std=None):
